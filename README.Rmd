...
You can find all outdegrees to synsetids using the `get_outdegrees` function.
...
Please note that it is not possible to obtain antonyms (linkid = 30) using this method.

...
download_wordnet <- function(debug = FALSE) {
    ...
    temploc <- tempfile("sqlite-31.db.zip")
        utils::download.file("https://downloads.sourceforge.net/project/wnsql/wnsql3/sqlite/3.1/sqlite-31.db.zip?r=http%3A%2F%2Fsourceforge.net%2Fprojects%2Fwnsql%2Ffiles%2Fwnsql3%2Fsqlite%2F3.1%2Fsqlite-31.db.zip%2Fdownload&ts=1409711250&use_mirror=iweb", temploc, quiet = FALSE, mode = "wb")
